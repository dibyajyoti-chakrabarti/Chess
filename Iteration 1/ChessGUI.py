...
Label(chess, padx=440,pady=425, bg = "black").place(x=80,y=20)

Label(chess, padx = 30, pady = 431, bg = "black", font = ("Britannic Bold",40,"bold")).place(x=20,y=20)
Label(chess,text = "8", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=50)
Label(chess,text = "7", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=155)
Label(chess,text = "6", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=260)
Label(chess,text = "5", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=365)
Label(chess,text = "4", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=470)
Label(chess,text = "3", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=575)
Label(chess,text = "2", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=680)
Label(chess,text = "1", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=785)

Label(chess,text = "Current Player", bg = "black", fg = "white", font = ("Times New Roman",25,"bold")).place(x=1070,y=150)
Label(chess, bg = "green", padx=70,pady=30, font = ("Britannic Bold",40,"bold")).place(x=1140,y=240)
Label(chess, bg = "white", padx=60,pady=20, font = ("Britannic Bold",40,"bold")).place(x=1150,y=250)

alphabet_index = '''  A   B   C   D   E   F   G   H   '''
Label(chess, padx = 440, bg = "black", font = ("Britannic Bold",40,"bold")).place(x=80,y=880)
Label(chess,text = alphabet_index, bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=85,y=880)

Label(chess,text = "", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold"),padx=130,pady=500).place(x=1450,y=0)
    ...
    def buttonLayout():
        ...
        def possibleMoves(i,j):
            ...
            def displayMoves(x_list, y_list,piece):
                ...
                def update_board(i,j,y,x,piece):
                    ...
                    def whiteWins():
                        ...
                        Label(whiteWinner,text="We have a winner!", fg="white", font= ("Bernard MT Condensed", 25, 'bold'), bg="#58B11A",  anchor='n',padx=15,pady=5).place(x=100, y=50)
                        Label(whiteWinner, text=newMsg, bg="black", fg="white", font= ("Times New Roman",17, 'bold')).place(x=0,y=120)
                        Label(whiteWinner, text=" ", bg="green", fg="white", font= ("Times New Roman",25, 'bold'),padx=43,pady=28).place(x = 240,y = 200)
                        Label(whiteWinner, text=" ", bg="white", fg="white", font= ("Times New Roman",25, 'bold'),padx=33,pady=18).place(x = 250,y = 210)
                    ...
                    def blackWins():
                        ...
                        Label(blackWinner,text="We have a winner!", fg="black", font= ("Bernard MT Condensed", 25, 'bold'), bg="#58B11A",  anchor='n',padx=15,pady=5).place(x=100, y=50)
                        Label(blackWinner, text=newMsg, bg="#FBF5F5", fg="black", font= ("Times New Roman",17, 'bold')).place(x=0,y=120)
                        Label(blackWinner, text=" ", bg="green", fg="black", font= ("Times New Roman",25, 'bold'),padx=43,pady=28).place(x = 240,y = 200)
                        Label(blackWinner, text=" ", bg="black", fg="black", font= ("Times New Roman",25, 'bold'),padx=33,pady=18).place(x = 250,y = 210)
                    ...
                    if counter %2 != 0:
                        Label(chess, padx = 30, pady = 431, bg = "black", font = ("Britannic Bold",40,"bold")).place(x=20,y=20)
                        Label(chess,text = "1", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=50)
                        Label(chess,text = "2", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=155)
                        Label(chess,text = "3", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=260)
                        Label(chess,text = "4", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=365)
                        Label(chess,text = "5", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=470)
                        Label(chess,text = "6", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=575)
                        Label(chess,text = "7", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=680)
                        Label(chess,text = "8", bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=40,y=785)



                        alphabet_index = '''  H   G   F   E   D   C   B   A   '''
                        Label(chess, padx = 440, bg = "black", font = ("Britannic Bold",40,"bold")).place(x=80,y=880)
                        Label(chess,text = alphabet_index, bg = "black", fg = "white", font = ("Britannic Bold",40,"bold")).place(x=85,y=880)

                        Label(chess, bg = "black", padx=60,pady=20, font = ("Britannic Bold",40,"bold")).place(x=1150,y=250)
            ...
            def ch_whiteWins():
                ...
                Label(whiteWinner,text="We have a winner!", fg="white", font= ("Bernard MT Condensed", 25, 'bold'), bg="#58B11A",  anchor='n',padx=15,pady=5).place(x=100, y=50)
                Label(whiteWinner, text=newMsg, bg="black", fg="white", font= ("Times New Roman",17, 'bold')).place(x=40,y=120)
                Label(whiteWinner, text=" ", bg="green", fg="white", font= ("Times New Roman",25, 'bold'),padx=43,pady=28).place(x = 240,y = 200)
                Label(whiteWinner, text=" ", bg="white", fg="white", font= ("Times New Roman",25, 'bold'),padx=33,pady=18).place(x = 250,y = 210)
            ...
            def ch_blackWins():
                ...
                Label(blackWinner,text="We have a winner!", fg="black", font= ("Bernard MT Condensed", 25, 'bold'), bg="#58B11A",  anchor='n',padx=15,pady=5).place(x=100, y=50)
                Label(blackWinner, text=newMsg, bg="#FBF5F5", fg="black", font= ("Times New Roman",17, 'bold')).place(x=40,y=120)
                Label(blackWinner, text=" ", bg="green", fg="black", font= ("Times New Roman",25, 'bold'),padx=43,pady=28).place(x = 240,y = 200)
                Label(blackWinner, text=" ", bg="black", fg="black", font= ("Times New Roman",25, 'bold'),padx=33,pady=18).place(x = 250,y = 210)
                ...
                if piece == "P":
                    ...
                    if i == 1:
                        def promote_bishop():
                            ...
                            Label(chess,text = "", bg = "black", fg = "white", font = ("Times New Roman",20,"bold"),padx=150,pady=40).place(x=1450,y=10)

                            
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "White Bishop", bg = "black", fg = "light green", font = ("Times New Roman",20,"bold")).place(x=1470,y=60)
                        ...
                        def promote_knight():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "White Knight", bg = "black", fg = "light green", font = ("Times New Roman",20,"bold")).place(x=1470,y=60)
                        ...
                        def promote_rook():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "White Rook", bg = "black", fg = "light green", font = ("Times New Roman",23,"bold")).place(x=1470,y=60)
                        ...
                        def promote_queen():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "White Queen", bg = "black", fg = "light green", font = ("Times New Roman",23,"bold")).place(x=1460,y=60)
                ...
                if piece == "p":
                    ...
                    if i == 1:
                        def promote_bishop():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "Black Bishop", bg = "black", fg = "light blue", font = ("Times New Roman",20,"bold")).place(x=1470,y=60)
                        ...
                        def promote_knight():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "Black Knight", bg = "black", fg = "light blue", font = ("Times New Roman",20,"bold")).place(x=1470,y=60)
                        ...
                        def promote_rook():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "Black Rook", bg = "black", fg = "light blue", font = ("Times New Roman",23,"bold")).place(x=1470,y=60)
                        ...
                        def promote_queen():
                            ...
                            Label(chess,text = "Selected:", bg = "black", fg = "white", font = ("Times New Roman",20,"bold")).place(x=1500,y=10)
                            Label(chess,text = "Black Queen", bg = "black", fg = "light blue", font = ("Times New Roman",23,"bold")).place(x=1460,y=60)
